...
**ProStore** — веб-приложение для хранения, организации и обмена промтами (промптами для AI). Каталог лучших промтов с возможностью публикации, голосования и избранного.

## Описание проекта

ProStore позволяет:

- **Создавать и хранить промты** — личная коллекция промтов с категориями и тегами
- **Публиковать промты** — делиться промтами с сообществом (приватные/публичные)
- **Браузить каталог** — просматривать новые и популярные публичные промты на главной
- **Голосовать и ставить лайки** — оценивать понравившиеся публичные промты
- **Вести заметки** — дополнительные заметки в личном кабинете
- **Организовывать избранное** — помечать важные промты как избранные

### Основные разделы

| Раздел | Описание |
|--------|----------|
| Главная | Каталог публичных промтов: «Новые» и «Популярные» |
| Dashboard | Личный кабинет: промты, заметки, избранное, история |
| Публичные промты | Просмотр и поиск по общему каталогу |
| Мои промты | Управление своими промтами |

### Аутентификация

Вход через **Google OAuth** (NextAuth). Гости могут просматривать публичные промты; для добавления, лайков и личного кабинета требуется авторизация.
